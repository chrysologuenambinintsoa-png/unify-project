      ...
      <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-2xl shadow-2xl p-8 w-full max-w-md border-2 border-amber-200">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-2xl font-bold text-amber-900">Créer un groupe</h2>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-bold text-amber-900 mb-2">Nom du groupe</label>
            <Input
              type="text"
              value={formData.name}
          ...
          <div className="flex items-center gap-3 bg-amber-100 p-3 rounded-lg">
            ...
            />
            <label htmlFor="isPrivate" className="text-sm font-bold text-amber-900 cursor-pointer flex-1">
              Groupe privé 🔒
            </label>
          </div>
