...
export function PageSkeleton() {
  return (
    <div className="py-6">
      ...
      <motion.div
        className="w-full h-64 bg-gradient-to-r from-gray-300 to-gray-200 dark:from-gray-700 dark:to-gray-600"
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          {/* Avatar Skeleton */}
          <div className="w-32 h-32 rounded-xl bg-gray-300 dark:bg-gray-700 border-4 border-white dark:border-gray-800 flex-shrink-0" />
          ...
          {/* Button Skeleton */}
          <div className="h-10 w-32 bg-gray-300 dark:bg-gray-700 rounded-lg flex-shrink-0" />
        </motion.div>

        {/* Description Skeleton */}
        <motion.div
          className="bg-white dark:bg-gray-900 rounded-lg p-6 mb-6 space-y-2"
          animate={{ opacity: [0.5, 1, 0.5] }}
